...
export const PostWeddingRecap: React.FC<PostWeddingRecapProps> = ({ isDarkMode, mediaItems, isAdmin, userName }) => {
  ...
  // Neuer State für Moment-Formular
  ...
  // Echte Firebase-Integration statt Sample-Daten
  useEffect(() => {
  ...
  const handleSaveMoment = async () => {
    try {
      ...
      console.error("Fehler beim Speichern des Moments:", error)
      setError("Fehler beim Speichern des Moments. Bitte versuche es erneut.")
    } finally {
      setIsSaving(false)
    }
  }
  ...
  const handleDeleteCard = async (cardId: string) => {
    ...
    try {
      ...
      console.error("Fehler beim Löschen der Dankeskarte:", error)
      setError("Fehler beim Löschen der Dankeskarte. Bitte versuche es erneut.")
    } finally {
      setIsSaving(false)
    }
  }
